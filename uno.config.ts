  ...
  shortcuts: [
    {
      ...
      'action-button': 'border-box flex gap-2 items-center cursor-pointer px2 py1 text-sm op75 hover:op100 hover:bg-hover',
      'action-button-active': 'bg-primary/10 dark:bg-primary/15 text-primary border border-box flex gap-2 items-center cursor-pointer px2 py1 text-sm op75 hover:op100',
    },
